...
export interface DecryptionShare {
   ...
   */
  fragments?: [DecryptionFragment, ...(DecryptionFragment)[]];
  [k: string]: any;
}
/**
...
/**
 * A fragment of a missing trustee's share of a decryption, including the LaGrange coefficient.
 */
export interface DecryptionFragment {
  /**
   * The index of the trustee who produced this fragment.
   */
  trustee_index: number;
  fragment: BigNaturalNumber2;
